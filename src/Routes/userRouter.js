...
router.get('/deleted', middlewareControler.verifyTokenIsAdmin, asyncHandler(UserController.getAllUserDeleted))
...
router.get('/profile', middlewareControler.verifyToken, asyncHandler(UserController.getProfile));
